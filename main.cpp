...
//#define SEQUENCE_PATH "data/rgbd_dataset_freiburg12_desk" // La anterior escena pero completa
//#define SEQUENCE_PATH "data/rgbd_dataset_freiburg13_long_office_household" // (test26) parecida a fr2_desk
...
int main(int argc, char const *argv[])
{
    ...
    std::string forest_file_name("test_data/test21.txt"); // Nombre del arbol a leerse
