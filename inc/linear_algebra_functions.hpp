...
// Funcion que devuelve un objeto affine a partir de un vector xi
cv::Affine3d TwistCoord_2_CvAffine3d(const myVector6d &xi);

// Funcion que devuelve un objeto cv::affine a partir de un eigen::Affine
cv::Affine3d EigenAffine3d_2_CvAffine3d(const Eigen::Affine3d &affine);
